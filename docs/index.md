...
### Gerador de Nomes de Repetidoras

Utilize o [Gerador de Nomes de Repetidoras](nomes-repetidoras.md) para criar um nome normalizado para a sua repetidora MeshCore utilizando um padrão definido de abreviações, a fim de evitar conflito entre cidades.
